...
1) PBS-Java supports Currency conversion. PBS-Go currently has it disabled as it's still under dev [issue 280](https://github.com/prebid/prebid-server/issues/280), [issue 760](https://github.com/prebid/prebid-server/pull/760). PBS-Java [PR 22](https://github.com/rubicon-project/prebid-server-java/pull/22)
...
(per-impression option is in progress [PR 154](https://github.com/rubicon-project/prebid-server-java/pull/154)),
...
- All adapters have been ported to use OpenRTB directly in PBS-Java. PBS-Go [Issue 211](https://github.com/prebid/prebid-server/issues/211)
