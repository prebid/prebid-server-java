...
class ZonedDateTimeModule extends SimpleModule {
    ...
    ZonedDateTimeModule() {
        addSerializer(ZonedDateTime, new ZonedDateTimeSerializer())
        addDeserializer(ZonedDateTime, new ZonedDateTimeDeserializer())
    }

    private static class ZonedDateTimeSerializer extends JsonSerializer<ZonedDateTime> {

        @Override
        void serialize(ZonedDateTime value, JsonGenerator generator,
    ...
    private static class ZonedDateTimeDeserializer extends JsonDeserializer<ZonedDateTime> {
        ...
        @Override
        ZonedDateTime deserialize(JsonParser parser, DeserializationContext ctx) throws IOException {
