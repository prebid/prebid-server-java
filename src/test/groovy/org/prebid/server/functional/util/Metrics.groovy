...
class Metrics {
    ...
    static class Module {
        ...
        private static String getBasicModuleMetric(ModuleName name, Stage stage, String suffix) {
            "modules.module.${name.code}.stage.${stage.metricValue}.hook.${name.code}-${stage.value}-hook.${suffix}"
        }
    }
    ...
    static class Privacy {
        ...
        static String noDisclosedVendors() {
            'privacy.tcf.no-disclosed-vendors'
        }
