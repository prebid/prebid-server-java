...
class TcfFullTransmitEidsActivitiesSpec extends PrivacyBaseSpec {
    ...
    private static List<EnforcementRequirement> getLegalEnforcementRequirements(Purpose purpose) {
    ...
    private static List<EnforcementRequirement> getCompanyEnforcementRequirements(Purpose purpose) {
        [new EnforcementRequirement(purpose: purpose,
                restrictionType: [REQUIRE_CONSENT, UNDEFINED],
                vendorIdGvl: GENERIC_VENDOR_ID,
                enforcePurpose: NO,
