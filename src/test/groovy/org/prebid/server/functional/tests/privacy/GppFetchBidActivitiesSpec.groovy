...
class GppFetchBidActivitiesSpec extends PrivacyBaseSpec {
    ...
    def "PBS auction call when request have different gpp consent should call bid adapter"() {
        ...
        where:
        gppConsent                           | gppSid
        new UsNatV1Consent.Builder().build() | USP_NAT_V1
        new UsCaV1Consent.Builder().build()  | USP_CA_V1
        new UsVaV1Consent.Builder().build()  | USP_VA_V1
        new UsCoV1Consent.Builder().build()  | USP_CO_V1
        new UsUtV1Consent.Builder().build()  | USP_UT_V1
        new UsCtV1Consent.Builder().build()  | USP_CT_V1
    }
