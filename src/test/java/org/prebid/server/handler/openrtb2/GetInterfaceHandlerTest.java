...
public class GetInterfaceHandlerTest extends VertxTest {

    @Mock
    private GetInterfaceRequestFactory getInterfaceRequestFactory;
    @Mock
    ...
    private GetInterfaceHandler target;
    @Mock
    ...
    public void setUp() {
        ...
        target = new GetInterfaceHandler(
                0.01,
    ...
    public void shouldSetRequestTypeMetricToAuctionContext() {
        // given
        given(getInterfaceRequestFactory.fromRequest(any(), anyLong()))
                .willReturn(Future.succeededFuture(givenAuctionContext(identity())));
        given(getInterfaceRequestFactory.enrichAuctionContext(any()))
    ...
    public void shouldSkipAuction() {
        ...
        // then
        verify(getInterfaceRequestFactory, never()).enrichAuctionContext(any());
        verify(metrics).updateRequestTypeMetric(eq(MetricName.openrtb2web), eq(MetricName.ok));
    ...
    private AuctionContext givenAuctionContext(
        ...
        final AuctionContext.AuctionContextBuilder auctionContextBuilder = AuctionContext.builder()
                ...
                .hookExecutionContext(HookExecutionContext.of(Endpoint.openrtb2_get_interface))
