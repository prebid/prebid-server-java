...
public class AuctionHandlerTest extends VertxTest {
    ...
    public void shouldUseTimeoutFromRequest() {
        // given
        given(auctionRequestFactory.fromRequest(any()))
                .willReturn(Future.succeededFuture(givenBidRequestContext(BidRequest.builder().imp(emptyList()).tmax(1000L)
                        .build())));
    ...
    public void shouldUseMaxTimeoutIfTimeoutInRequestExceedsLimit() {
        // given
        given(auctionRequestFactory.fromRequest(any()))
                .willReturn(Future.succeededFuture(givenBidRequestContext(BidRequest.builder().imp(emptyList()).tmax(6000L)
                        .build())));
    ...
    public void shouldIncrementImpsRequestedMetrics() {
        // given
        given(auctionRequestFactory.fromRequest(any()))
                .willReturn(Future.succeededFuture(givenBidRequestContext(
    ...
    public void shouldPassInternalServerErrorEventToAnalyticsReporterIfAuctionFails() {
        ...
        given(exchangeService.holdAuction(any(), any(), any(), any())).willThrow(new RuntimeException(
    ...
    private static BidRequestContext givenBidRequestContext(BidRequest bidRequest) {
        return BidRequestContext.of(bidRequest, emptyMap(), emptyMap(), null);
    }
