...
public class AmpHandlerTest extends VertxTest {
    ...
    public void shouldRespondWithExpectedResponse() {
        ...
        given(exchangeService.holdAuction(any()))
                .willReturn(givenBidResponse(
                        mapper.valueToTree(ExtPrebid.of(ExtBidPrebid.of(null, targeting, null, null, null), null))));
                        ...
                        .seatbid(singletonList(SeatBid.builder()
                                ...
                                .bid(singletonList(Bid.builder()
                                        .ext(mapper.valueToTree(
                                                ExtPrebid.of(ExtBidPrebid.of(null, targeting, null, null, null),
    ...
    public void shouldIncrementOkAmpRequestMetrics() {
        ...
        given(exchangeService.holdAuction(any()))
                .willReturn(givenBidResponse(mapper.valueToTree(
                        ExtPrebid.of(ExtBidPrebid.of(null, null, null, null, null), null))));
    ...
    public void shouldPassSuccessfulEventToAnalyticsReporter() {
        ...
        given(exchangeService.holdAuction(any()))
                .willReturn(givenBidResponse(mapper.valueToTree(
                        ExtPrebid.of(ExtBidPrebid.of(null, singletonMap("hb_cache_id_bidder1", "value1"), null, null, null),
                                null))));
