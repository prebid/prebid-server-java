...
public class AdminResourceWrapperTest extends VertxTest {
    ...
    private AdminResourceWrapper target;
    ...
    @Before
    public void setUp() {
        target = new AdminResourceWrapper(PATH, handler, true, true);
    ...
    public void routeShouldCallRouterWhenNotProtectedAndCredentialsProvided() {
        // given
        target = new AdminResourceWrapper(PATH, handler, true, false);
        target.withCredentials(adminEndpointCredentials);
