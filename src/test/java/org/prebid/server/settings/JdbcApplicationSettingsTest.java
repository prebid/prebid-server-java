...
public class JdbcApplicationSettingsTest {
    ...
    public static void beforeClass() throws SQLException {
        ...
        connection.createStatement().execute("CREATE TABLE accounts_account (id SERIAL PRIMARY KEY, uuid varchar(40) " +
                ...
                "video_cache_ttl INT, analytics_sampling_factor INT, events_enabled BIT, enforce_gdpr BIT);");
        ...
        connection.createStatement().execute("insert into accounts_account " +
                "(uuid, price_granularity, banner_cache_ttl, video_cache_ttl, analytics_sampling_factor, events_enabled, enforce_gdpr)" +
                " values ('accountId','med', 100, 100, 1, TRUE, TRUE);");
