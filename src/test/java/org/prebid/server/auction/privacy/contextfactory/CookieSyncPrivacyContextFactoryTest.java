...
public class CookieSyncPrivacyContextFactoryTest extends VertxTest {
    ...
    private CookieSyncPrivacyContextFactory target;
    ...
    public void contextFromShouldReturnExpectedPrivacy() {
        ...
        given(privacyExtractor.validPrivacyFrom(any())).willReturn(privacy);
        ...
        // when
        final PrivacyContext result = target.contextFrom(null, httpRequest, account, timeout).result();
    ...
    public void contextFromShouldUseRequestIp() {
        ...
        // when
        target.contextFrom(null, httpRequest, account, timeout);
