...
public class ExchangeServiceTest extends VertxTest {
    ...
    @Before
    public void setUp() {
        given(bidResponseCreator.create(anyList(), any(), any(), any(), any(), any(), any(), anyBoolean()))
    ...
    public void shouldCallBidResponseCreatorWithEnabledDebugTrueIfTestFlagIsTrue() {
        ...
        // then
        verify(bidResponseCreator).create(anyList(), eq(bidRequest), any(), any(), any(), any(), any(), eq(true));
    }
    ...
    public void shouldPassReducedGlobalTimeoutToConnectorAndOriginalToBidResponseCreator() {
        ...
        verify(bidResponseCreator).create(anyList(), any(), any(), any(), any(), any(), same(timeout), anyBoolean());
    }
    ...
    public void shouldDropBidIfPrebidExceptionWasThrownDuringCurrencyConversion() {
        ...
        verify(bidResponseCreator).create(argumentCaptor.capture(), any(), any(), any(), any(), any(), any(),
                anyBoolean());
