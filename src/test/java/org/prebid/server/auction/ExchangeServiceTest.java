...
public class ExchangeServiceTest extends VertxTest {
    ...
    public void shouldUseConcreteOverGeneralSiteWithExtPrebidBidderConfig() {
        ...
        final ExtBidderConfig extBidderConfig = ExtBidderConfig.of(
                ExtBidderConfigOrtb.of(siteWithPage, null, null));
        ...
        final ExtBidderConfig allExtBidderConfig = ExtBidderConfig.of(
                ExtBidderConfigOrtb.of(siteWithDomain, null, null));
    ...
    public void shouldUseConcreteOverGeneralAppWithExtPrebidBidderConfig() {
        ...
        final ExtBidderConfig extBidderConfig = ExtBidderConfig.of(
                ExtBidderConfigOrtb.of(null, appWithPublisherId, null));
        final ExtRequestPrebidBidderConfig concreteFpdConfig = ExtRequestPrebidBidderConfig.of(
                singletonList("someBidder"), extBidderConfig);
        ...
        final ExtBidderConfig allExtBidderConfig = ExtBidderConfig.of(
                ExtBidderConfigOrtb.of(null, appWithUpdatedPublisher, null));
        final ExtRequestPrebidBidderConfig allFpdConfig = ExtRequestPrebidBidderConfig.of(singletonList("*"),
                allExtBidderConfig);
    ...
    public void shouldUseConcreteOverGeneralUserWithExtPrebidBidderConfig() {
        ...
        final ExtBidderConfig extBidderConfig = ExtBidderConfig.of(
                ExtBidderConfigOrtb.of(null, null, bidderConfigUser));
        final ExtRequestPrebidBidderConfig concreteFpdConfig = ExtRequestPrebidBidderConfig.of(
                singletonList("someBidder"), extBidderConfig);

        final ObjectNode emptyUser = mapper.valueToTree(User.builder().build());
        final ExtBidderConfig allExtBidderConfig = ExtBidderConfig.of(
                ExtBidderConfigOrtb.of(null, null, emptyUser));
        final ExtRequestPrebidBidderConfig allFpdConfig = ExtRequestPrebidBidderConfig.of(singletonList("*"),
                allExtBidderConfig);
    ...
    public void shouldPassReducedGlobalTimeoutToConnectorAndOriginalToBidResponseCreator() {
        ...
        givenBidder(givenSeatBid(singletonList(givenBidderBid(bid))));
        ...
        verify(bidResponseCreator).create(any(), any(), any());
    }
    ...
    public void shouldPopulateMissingBidsWithUnknownRejectionReason() {
        ...
        final Imp imp1 = givenImp(impExt, impBuilder -> impBuilder.id("impId1"));
        final Imp imp2 = givenImp(impExt, impBuilder -> impBuilder.id("impId2"));
        final BidRequest bidRequest = givenBidRequest(List.of(imp1, imp2));

        final BidderSeatBid seatBid = givenSingleSeatBid(
                givenBidderBid(givenBid(bidBuilder -> bidBuilder.id("bidId1").impid("impId1"))));

        givenBidder("someBidder", mock(Bidder.class), seatBid);

        final AuctionContext auctionContext = givenRequestContext(bidRequest);

        // when
        final Future<AuctionContext> context = exchangeService.holdAuction(auctionContext);
