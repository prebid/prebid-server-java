...
public class Ortb2RequestFactoryTest extends VertxTest {
    ...
    @Test
    public void enrichWithDebugContextShouldSetDebugEnabledToTrueIfExtRequestPrebidDebugFlagIsOne() {
        // given
        final BidRequest bidRequest = BidRequest.builder()
                .tmax(1000L)
        ...
        // when
        final AuctionContext result = target.enrichWithDebugContext(
                AuctionContext.builder()
                        .bidRequest(bidRequest)
                        .account(Account.builder().allowDebug(true).build())
                        .build());

        // then

        assertThat(result)
                .extracting(AuctionContext::getDebugContext)
                .containsExactly(DebugContext.of(true, TraceLevel.basic));
    }

    @Test
    public void enrichWithDebugContextShouldSetDebugEnabledToFalseIfAccountDebugAllowFlagIsFalse() {
        // given
        final BidRequest bidRequest = BidRequest.builder()
                .tmax(1000L)
                .ext(ExtRequest.of(ExtRequestPrebid.builder()
        ...
        final AuctionContext result = target.enrichWithDebugContext(
                AuctionContext.builder()
                        .bidRequest(bidRequest)
                        .account(Account.builder().allowDebug(false).build())
                        .build());

        // then
        assertThat(result)
                .extracting(AuctionContext::getDebugContext)
                .containsExactly(DebugContext.of(false, TraceLevel.basic));
    }

    @Test
    public void enrichWithDebugContextShouldSetDebugEnabledToTrueIfTestFlagIsOne() {
        // given
        final BidRequest bidRequest = BidRequest.builder().test(1).build();
        ...
        assertThat(result)
                .extracting(AuctionContext::getDebugContext)
                .containsExactly(DebugContext.of(true, null));
    }
