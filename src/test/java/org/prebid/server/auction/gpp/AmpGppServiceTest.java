...
public class AmpGppServiceTest {
    ...
    public void contextFromShouldReturnExpectedGppContext() {
        ...
        // when
        final GppContext result = ampGppService.contextFrom(auctionContext).result();
    ...
    public void contextFromShouldAddWarningsInAuctionContextIfDebugEnabled() {
        ...
        // when
        ampGppService.contextFrom(auctionContext);
    ...
    public void updateBidRequestShouldReturnSameBidRequest() {
        ...
        // when
        final BidRequest result = ampGppService.updateBidRequest(bidRequest, auctionContext);
