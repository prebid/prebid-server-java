...
public class LoganBidderTest extends VertxTest {

    private static final String ENDPOINT_URL = "https://test.endpoint.com/";

    private LoganBidder loganBidder;

    @Before
    public void setUp() {
        loganBidder = new LoganBidder(ENDPOINT_URL, jacksonMapper);
    }

    @Test
    public void creationShouldFailOnInvalidEndpointUrl() {
        assertThatIllegalArgumentException().isThrownBy(() -> new LoganBidder("invalid_url", jacksonMapper));
    }
    ...
    public void makeHttpRequestsShouldMakeOneRequestPerImp() {
        ...
        // when
        final Result<List<HttpRequest<BidRequest>>> result = loganBidder.makeHttpRequests(bidRequest);
    ...
    @Test
    public void makeHttpRequestsShouldSetImpExtTypeToPublisher() {
        // given
        final BidRequest bidRequest = givenBidRequest(impCustomizer -> impCustomizer
                .ext(mapper.valueToTree(ExtPrebid.of(null,
                        ExtImpLogan.of("somePlacementId")))));
        ...
        assertThat(result.getValue())
                ...
                .extracting(impExt -> impExt.get("bidder"))
                .extracting(impExtBidder -> impExtBidder.get("type"))
                .extracting(JsonNode::asText)
                .containsExactly("publisher");
    }

    @Test
    public void makeHttpRequestsShouldPassImpExtPlacementId() {
        // given
        final BidRequest bidRequest = givenBidRequest(impCustomizer -> impCustomizer
                .ext(mapper.valueToTree(ExtPrebid.of(null,
                        ExtImpLogan.of("somePlacementId")))));
        ...
        assertThat(result.getValue())
                ...
                .extracting(Imp::getExt)
                .extracting(impExt -> impExt.get("bidder"))
                .extracting(impExtBidder -> impExtBidder.get("placementId"))
                .extracting(JsonNode::asText)
                .containsExactly("somePlacementId");
    }
    ...
    public void makeBidsShouldReturnEmptyListIfBidResponseIsNull() throws JsonProcessingException {
        ...
        // when
        final Result<List<BidderBid>> result = loganBidder.makeBids(httpCall, null);
