...
public class TtxBidderTest extends VertxTest {
        ...
        final BidRequest bidRequest = BidRequest.builder()
                .imp(singletonList(
                        givenImp(impBuilder -> impBuilder
                                ...
                                .ext(mapper.valueToTree(ExtImp.of(ExtImpTtx.of("11", null, "3")))))))
                .build();
    ...
    public void makeHttpRequestsShouldUpdatePlacementAndStartDelayIfProdIsInstream() {
        ...
        final BidRequest bidRequest = BidRequest.builder()
                .imp(singletonList(
                        givenImp(impBuilder -> impBuilder
                                .video(validVideo())
                                .ext(mapper.valueToTree(ExtImp.of(ExtImpTtx.of("11", null, "instream")))))))
                .build();
    ...
    private static Imp givenImp(Function<Imp.ImpBuilder, Imp.ImpBuilder> impCustomizer) {
        return impCustomizer.apply(Imp.builder()
                ...
                .ext(mapper.valueToTree(ExtImp.of(ExtImpTtx.of("siteId", "zoneId", "productId")))))
                .build();
    }
