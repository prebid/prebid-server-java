...
public class NextMilleniumBidderTest extends VertxTest {
    ...
    @Test
    public void makeBidsWithTwoSeatBidsShouldReturnError() throws JsonProcessingException {
        // given
        final BidRequest bidRequest = givenBidRequest(identity());
        final HttpCall<BidRequest> httpCall = givenHttpCall(bidRequest,
        ...
        // then
        assertThat(result.getErrors().get(0).getMessage()).startsWith("Invalid SeatBids count:");
    }
