...
public class ConversantUsersyncerTest {
    ...
    public void creationShouldFailOnNullArguments() {
        ...
        assertThatNullPointerException().isThrownBy(() -> new ConversantUsersyncer("", "", false, null));

    }

    @Test
    public void creationShouldInitExpectedUsercyncInfo() {
        assertThat(new ConversantUsersyncer("//usersync.org/", "redirect", false, "http://external.org/").usersyncInfo())
