        ...
        final BidRequest bidRequest = BidRequest.builder()
                .imp(singletonList(Imp.builder()
                        ...
                        .ext(mapper.valueToTree(
                                ExtImp.of(ExtImpAdtelligent.of(15, 1, 2, BigDecimal.valueOf(3))))).build()))
                .user(User.builder()
        ...
        final BidRequest bidRequest = BidRequest.builder()
                .imp(asList(Imp.builder()
                        ...
                        Imp.builder()
                                ...
                                .banner(Banner.builder().build())
                                .ext(mapper.valueToTree(
                                        ExtImp.of(ExtImpAdtelligent.of(15, 1, 2, BigDecimal.valueOf(3)))))
                                .build()))
                .build();
    ...
    public void makeHttpRequestShouldReturnWithBidFloorPopulatedFromImpWhenIsMissedInImpExt() {
        ...
        final BidRequest bidRequest = BidRequest.builder()
                .imp(singletonList(Imp.builder()
                        ...
                        .ext(mapper.valueToTree(ExtImp.of(ExtImpAdtelligent.of(15, 1, 2, null))))
                        .build()))
                .build();
        ...
        final BidRequest bidRequest = BidRequest.builder()
                .imp(asList(Imp.builder()
                        ...
                        Imp.builder()
                                .banner(Banner.builder().build())
                                .ext(mapper.valueToTree(
                                        ExtImp.of(ExtImpAdtelligent.of(16, 1, 2, BigDecimal.valueOf(3)))))
                                .build()))
                .build();
