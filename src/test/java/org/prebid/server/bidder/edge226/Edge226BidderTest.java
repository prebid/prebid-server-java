...
public class Edge226BidderTest extends VertxTest {

    private static final String ENDPOINT_URL = "http://test-url.com";

    private final Edge226Bidder target = new Edge226Bidder(ENDPOINT_URL, jacksonMapper);

    @Test
    public void creationShouldFailOnInvalidEndpointUrl() {
        assertThatIllegalArgumentException().isThrownBy(() -> new Edge226Bidder("invalid_url", jacksonMapper));
    }
    ...
    private static BidRequest givenBidRequest(UnaryOperator<Imp.ImpBuilder>... impCustomizers) {
        return BidRequest.builder()
                .imp(Arrays.stream(impCustomizers).map(Edge226BidderTest::givenImp).toList())
                .build();
    }
    ...
    private static ObjectNode givenImpExt(UnaryOperator<Edge226ImpExt.Edge226ImpExtBuilder> impExtBuilder) {
        return mapper.valueToTree(ExtPrebid.of(null, impExtBuilder.apply(Edge226ImpExt.builder()).build()));
    }
