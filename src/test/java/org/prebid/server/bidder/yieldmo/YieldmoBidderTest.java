...
public class YieldmoBidderTest extends VertxTest {
    ...
    public void makeHttpRequestsShouldAddPbadslotToImpExtIfPresentAndNotEmpty() {
        // given
        final ObjectNode impExt = mapper.valueToTree(ExtImp.of(ExtImpYieldmo.of(null)));
    ...
    public void makeHttpRequestsShouldNotAddPbadslotToImpExtIfNull() {
        // given
        final BidRequest bidRequest = givenBidRequest(impBuilder ->
                impBuilder.ext(mapper.valueToTree(ExtImp.of(ExtImpYieldmo.of(null)))));
    ...
    private static Imp givenImp(Function<Imp.ImpBuilder, Imp.ImpBuilder> impCustomizer) {
        return impCustomizer.apply(Imp.builder()
                        ...
                        .ext(mapper.valueToTree(ExtImp.of(ExtImpYieldmo.of(PLACEMENT_VALUE)))))
                .build();
    }
