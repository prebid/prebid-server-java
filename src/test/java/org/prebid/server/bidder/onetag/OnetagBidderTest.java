...
public class OnetagBidderTest extends VertxTest {
    ...
    public void makeHttpRequestsShouldCreateCorrectURL() {
        ...
        // when
        final Result<List<HttpRequest<BidRequest>>> result = onetagBidder.makeHttpRequests(bidRequest);
    ...
    public void makeHttpRequestsShouldUpdateImpExt() {
        ...
        final BidRequest bidRequest = BidRequest.builder()
                .imp(singletonList(Imp.builder()
                        .ext(mapper.valueToTree(ExtImp.of(ExtImpOnetag.of("somePubId", oneTagExt))))
                        .build()))
                .build();
    ...
    public void makeHttpRequestsShouldReturnErrorIfPubIdNotPresent() {
        ...
        final BidRequest bidRequest = BidRequest.builder()
                .imp(singletonList(Imp.builder()
                        .ext(mapper.valueToTree(ExtImp.of(ExtImpOnetag.of("", oneTagExt))))
                        .build()))
                .build();
    ...
    public void makeHttpRequestsShouldReturnErrorIfPubIdAreDifferentInImpExts() {
        ...
        final BidRequest bidRequest = givenBidRequest(
                ...
                requestBuilder -> requestBuilder.imp(Arrays.asList(
                        givenImp(identity()),
                        Imp.builder()
                                .ext(mapper.valueToTree(ExtImp.of(ExtImpOnetag.of("anotherPubId",
    ...
    public void makeBidsShouldReturnEmptyListIfBidResponseIsNull() throws JsonProcessingException {
        ...
        // when
        final Result<List<BidderBid>> result = onetagBidder.makeBids(httpCall, null);
    ...
    private static Imp givenImp(Function<Imp.ImpBuilder, Imp.ImpBuilder> impCustomizer) {
        return impCustomizer.apply(Imp.builder()
                ...
                .ext(mapper.valueToTree(ExtImp.of(ExtImpOnetag.of("somePubId", mapper.createObjectNode()))))
                .build();
    }
