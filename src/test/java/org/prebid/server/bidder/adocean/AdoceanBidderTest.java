...
public class AdoceanBidderTest extends VertxTest {
    ...
    public void makeBidsShouldReturnCorrectBidderBid() throws JsonProcessingException {
        ...
        final BidderHttpCall<Void> httpCall = givenHttpCall(null, mapper.writeValueAsString(adoceanResponseAdUnit));
    ...
    private static BidderHttpCall<Void> givenHttpCall(String requestBody, String responseBody)
