...
public class TrafficGateBidderTest extends VertxTest {
    ...
    public void makeHttpRequestsShouldMakeRequestWithUrl() {
        ...
        assertThat(result.getValue()).hasSize(1)
                .allSatisfy(httpRequest -> {
                    assertThat(httpRequest.getUri()).isEqualTo("https://anyHost.domain");
    ...
    public void makeBidsShouldReturnVideoBidIfVideoIsPresentInBidExtPrebidType() throws JsonProcessingException {
        ...
        assertThat(result.getValue()).containsExactly(BidderBid.of(Bid.builder()
                .ext(givenExtPrebidType("video")).impid("123").build(), video, "USD"));
    }
    ...
    public void makeBidsShouldReturnBannerBidIfBannerIsPresentInBidExtPrebidType() throws JsonProcessingException {
        ...
        assertThat(result.getErrors()).isEmpty();
        assertThat(result.getValue()).containsExactly(BidderBid.of(Bid.builder()
                .ext(givenExtPrebidType("banner")).impid("123").build(), banner, "USD"));
    }
    ...
    public void makeBidsShouldReturnAudioBidIfAudioIsPresentInBidExtPrebidType() throws JsonProcessingException {
        ...
        assertThat(result.getErrors()).isEmpty();
        assertThat(result.getValue()).containsExactly(BidderBid.of(Bid.builder()
                .ext(givenExtPrebidType("audio")).impid("123").build(), audio, "USD"));
    }
    ...
    @Test
    public void makeBidsShouldReturnDefaultBannerBidIfExtPrebidAreEmpty() throws JsonProcessingException {
        // given
        final BidderCall<BidRequest> httpCall = givenHttpCall(
                BidRequest.builder()
    ...
    private static Imp givenImp(UnaryOperator<Imp.ImpBuilder> impCustomizer) {
        return impCustomizer.apply(Imp.builder()
                        .id("123")
                        .ext(mapper.valueToTree(ExtPrebid.of(null, ExtImpTrafficGate.of("placementId", "anyHost")))))
                .build();
    }
    ...
    private static ObjectNode givenExtPrebidType(String type) {
