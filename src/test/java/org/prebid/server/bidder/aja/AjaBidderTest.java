...
public class AjaBidderTest extends VertxTest {
    ...
    private final AjaBidder target = new AjaBidder(ENDPOINT_URL, jacksonMapper);

    @Test
    public void creationShouldFailOnInvalidEndpointUrl() {
        assertThatIllegalArgumentException().isThrownBy(() -> new AjaBidder("invalid_url", jacksonMapper));
    }
    ...
    public void makeHttpRequestsShouldReturnErrorIfImpExtCouldNotBeParsed() {
        ...
        assertThat(result.getErrors().getFirst().getMessage()).startsWith("Failed to unmarshal ext.bidder impID");
    ...
    public void makeBidsShouldReturnErrorWithUnknownBidTypeIfNotSupportedBidType() throws JsonProcessingException {
        ...
        final BidderCall<BidRequest> httpCall = givenHttpCall(BidRequest.builder()
                ...
                mapper.writeValueAsString(
                        givenBidResponse(bidBuilder -> bidBuilder.id("test").impid("123"))));
        ...
        // then
        assertThat(result.getErrors()).hasSize(1)
                .containsOnly(BidderError.badInput("Response received for unexpected type of bid bidID: test"));
        assertThat(result.getValue()).isEmpty();
    }
