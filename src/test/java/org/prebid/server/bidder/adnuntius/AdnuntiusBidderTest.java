...
public class AdnuntiusBidderTest extends VertxTest {
    ...
    public void makeBidsShouldReturnErrorIfResponseBodyCouldNotBeParsed() {
        // given
        final BidderHttpCall<AdnuntiusRequest> httpCall = givenHttpCall("Incorrect body");
    ...
    public void makeBidsShouldReturnEmptyListIfResponseIsNull() {
        // given
        final BidderHttpCall<AdnuntiusRequest> httpCall = givenHttpCall("null");
    ...
    public void makeBidsShouldReturnEmptyListIfResponseAdsUnitsIsNull() {
        // given
        final BidderHttpCall<AdnuntiusRequest> httpCall = givenHttpCall("{}");
    ...
    public void makeBidsShouldSkipInvalidAdsUnits() throws JsonProcessingException {
        // given
        final BidderHttpCall<AdnuntiusRequest> httpCall = givenHttpCall(givenAdsUnit());
        final BidRequest bidRequest = givenBidRequest(givenImp(identity()));
    ...
    public void makeBidsShouldReturnCorrectSeatBids() throws JsonProcessingException {
        // given
        final BidderHttpCall<AdnuntiusRequest> httpCall = givenHttpCall(givenAdsUnit(givenAd(ad -> ad
    ...
    private BidderHttpCall<AdnuntiusRequest> givenHttpCall(String body) {
