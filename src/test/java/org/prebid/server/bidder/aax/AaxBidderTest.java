...
public class AaxBidderTest extends VertxTest {
    ...
    private static final String ENDPOINT_URL = "https://test.aax.net?src=external.prebidserver.com";

    private AaxBidder aaxBidder;

    @Before
    public void setup() {
        aaxBidder = new AaxBidder(ENDPOINT_URL, jacksonMapper);
    }

    @Test
    public void creationShouldFailOnInvalidEndpointUrl() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> new AaxBidder("invalid_url", jacksonMapper));
    }
    ...
    public void makeHttpRequestsShouldNotModifyIncomingRequest() {
        ...
        result = aaxBidder.makeHttpRequests(bidRequest);
