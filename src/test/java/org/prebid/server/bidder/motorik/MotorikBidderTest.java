...
public class MotorikBidderTest extends VertxTest {
    ...
    private MotorikBidder bidder;

    @Before
    public void setUp() {
        bidder = new MotorikBidder(ENDPOINT_URL, jacksonMapper);
    }

    @Test
    public void creationShouldFailOnInvalidEndpointUrl() {
        assertThatIllegalArgumentException().isThrownBy(() -> new MotorikBidder("invalid_url", jacksonMapper));
    }
    ...
    public void makeHttpRequestsShouldReturnHttpRequestWithCorrectUrl() {
        ...
        assertThat(result.getValue())
                ...
                .containsExactly("https://test.endpoint.com?k=testAccountId&name=testPlacementId");
    }
    ...
    public void makeHttpRequestsShouldReturnErrorIfImpExtCouldNotBeParsed() {
        ...
        assertThat(result.getErrors()).allMatch(error -> error.getType() == BidderError.Type.bad_input
                && error.getMessage().startsWith("Error parsing motorikExt Cannot deserialize"));
    }
    ...
    private static Imp givenImp(UnaryOperator<Imp.ImpBuilder> impCustomizer) {
        return impCustomizer.apply(Imp.builder()
                        ...
                        .ext(mapper.valueToTree(ExtPrebid.of(null,
                                ExtImpMotorik.of("testAccountId", "testPlacementId")))))
                .build();
    }
