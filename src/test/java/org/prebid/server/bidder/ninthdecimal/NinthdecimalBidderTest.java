...
public class NinthdecimalBidderTest extends VertxTest {
    ...
    public void creationShouldFailOnInvalidEndpointUrl() {
        assertThatIllegalArgumentException().isThrownBy(() -> new NinthdecimalBidder("invalid_url", jacksonMapper));
    }
    ...
    public void makeHttpRequestShouldReturnAllErrorsWithRequest() {
        ...
        final Imp impWithoutPubIdFirst = givenImp(identity(), ExtImpNinthdecimal.of(" ", null));
        final Imp impWithoutPubIdSecond = givenImp(identity(), ExtImpNinthdecimal.of(" ", null));
    ...
    private static BidRequest givenBidRequest(Function<Imp.ImpBuilder, Imp.ImpBuilder> impCustomizer) {
        return givenBidRequest(identity(), impCustomizer, ExtImpNinthdecimal.of("pubid", "placment"));
    }

    private static BidRequest givenBidRequest(Function<Imp.ImpBuilder, Imp.ImpBuilder> impCustomizer,
                                              ExtImpNinthdecimal extImpNinthdecimal) {
        return givenBidRequest(identity(), impCustomizer, extImpNinthdecimal);
    }
