...
public class ConsumableBidderTest extends VertxTest {
    ...
    public void makeBidsShouldReturnErrorIfResponseBodyCouldNotBeParsed() {
        // given
        final BidderHttpCall<ConsumableBidRequest> httpCall = BidderHttpCall.succeededHttp(null,
    ...
    public void makeBidsShouldSkipDecisionsWithNullPricing() throws JsonProcessingException {
        // given
        final BidderHttpCall<ConsumableBidRequest> httpCall = givenHttpCall(identity(),
    ...
    private static BidderHttpCall<ConsumableBidRequest> givenHttpCall(
