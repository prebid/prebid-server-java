...
public class PulsepointUsersyncerTest {
    ...
    public void creationShouldFailOnNullArguments() {
        ...
        assertThatNullPointerException().isThrownBy(() -> new PulsepointUsersyncer("", "", false, null));
    }

    @Test
    public void creationShouldInitExpectedUsercyncInfo() {
        assertThat(new PulsepointUsersyncer("//usersync.org/", "redirect", false, "http://external.org/").usersyncInfo())
