...
public class AxisBidderTest extends VertxTest {
    ...
    private AxisBidder axisBidder;

    @Before
    public void setUp() {
        axisBidder = new AxisBidder(ENDPOINT_URL, jacksonMapper);
    }
    ...
    public void makeHttpRequestsShouldReturnExpectedBidRequest() {
        ...
        // when
        final Result<List<HttpRequest<BidRequest>>> result = axisBidder.makeHttpRequests(bidRequest);
    ...
    public void makeBidsShouldReturnVideoBidIfImpHasVideoObject() throws JsonProcessingException {
        ...
        // when
        final Result<List<BidderBid>> result = axisBidder.makeBids(httpCall, bidRequest);
    ...
    public void makeBidsShouldReturnErrorsAndResult() throws JsonProcessingException {
        ...
        // when
        final Result<List<BidderBid>> result = axisBidder.makeBids(httpCall, null);
