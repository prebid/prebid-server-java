...
import org.prebid.server.bidder.facebook.model.FacebookExt;
import org.prebid.server.bidder.facebook.model.FacebookParams;
...
public class FacebookAdapterTest extends VertxTest {
    ...
    public void extractBidsShouldReturnBidBuildersWithExpectedFields() {
        // given
        adapterRequest = givenBidder(builder -> builder.bidderCode(ADAPTER).bidId("bidId").adUnitCode("adUnitCode"));
