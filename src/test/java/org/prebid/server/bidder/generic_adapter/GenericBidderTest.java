package org.prebid.server.bidder.generic_adapter;
...
public class GenericBidderTest extends VertxTest {
    ...
    private GenericBidder genericBidder;

    @Before
    public void setUp() {
        genericBidder = new GenericBidder(ENDPOINT_URL, jacksonMapper);
    }
    ...
    @Test
    public void makeBidsShouldReturnBannerBidIfBannerAndVideoAndNativeIsAbsentInRequestImp()
