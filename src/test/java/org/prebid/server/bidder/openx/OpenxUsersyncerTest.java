...
public class OpenxUsersyncerTest {
    ...
    public void creationShouldFailOnNullArguments() {
        ...
        assertThatNullPointerException().isThrownBy(() -> new OpenxUsersyncer("", "", false, null));
    }

    @Test
    public void creationShouldInitExpectedUsercyncInfo() {
        assertThat(new OpenxUsersyncer("https://rtb.openx.net/sync/prebid?r=", "redirect", false, "localhost").usersyncInfo())
