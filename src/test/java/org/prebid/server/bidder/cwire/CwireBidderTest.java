...
public class CwireBidderTest extends VertxTest {

    private static final String ENDPOINT_URL = "https://ortb.cwi.re/v1/bid";

    private CwireBidder cwireBidder;

    @Before
    public void setUp() {
        cwireBidder = new CwireBidder(ENDPOINT_URL, jacksonMapper);
    }
    ...
    public void makeHttpRequestsShouldReturnHttpRequestWithCorrectBodyHeadersAndMethod() {
        ...
        // when
        final Result<List<HttpRequest<BidRequest>>> result = cwireBidder.makeHttpRequests(bidRequest);
    ...
    public void makeBidsShouldReturnExpectedResult() throws JsonProcessingException {
        ...
        // when
        final Result<List<BidderBid>> result = cwireBidder.makeBids(httpCall, null);
    ...
    public void makeBidsShouldReturnEmptyResponseWhenWhereIsNoBid() throws JsonProcessingException {
        ...
        // when
        final Result<List<BidderBid>> result = cwireBidder.makeBids(httpCall, bidRequest);
    ...
    public void makeBidsShouldReturnEmptyBidderBidAndErrorListsIfSeatBidIsNotPresentInResponse()
        ...
        // when
        final Result<List<BidderBid>> result = cwireBidder.makeBids(httpCall, BidRequest.builder().build());
    ...
    public void makeBidsShouldReturnEmptyBidderWithErrorWhenResponseCanNotBeParsed() {
        ...
        assertThat(result.getErrors()).hasSize(1).element(0).satisfies(bidderError -> {
            ...
            assertThat(bidderError.getMessage()).startsWith("Error while decoding response");
        });
    }
