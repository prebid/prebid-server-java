package org.prebid.server.bidder.automatad;
...
public class AutomatadBidderTest extends VertxTest {

    private static final String ENDPOINT_URL = "https://randomurl.com";

    private AutomatadBidder automatadBidder;

    @Before
    public void setUp() {
        automatadBidder = new AutomatadBidder(ENDPOINT_URL, jacksonMapper);
    }
    ...
    public void makeHttpRequestsShouldCreateExpectedUrl() {
        ...
        // when
        final Result<List<HttpRequest<BidRequest>>> result = automatadBidder.makeHttpRequests(bidRequest);
    ...
    public void makeBidsShouldReturnErrorIfResponseBodyCouldNotBeParsed() {
        ...
        // when
        final Result<List<BidderBid>> result = automatadBidder.makeBids(httpCall, null);
