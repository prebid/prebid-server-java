...
public class SovrnAdapterTest extends VertxTest {
    ...
    public void extractBidsShouldReturnBidsBuilderWithExpectedFields() {
        ...
        assertThat(bids).hasSize(1)
                .element(0)
                .isEqualTo(org.prebid.server.proto.response.legacy.Bid.builder()
                        .bidId("bidId")
                        .code("adUnitCode")
                        .bidder("bidderCode")
                        .price(BigDecimal.ONE)
    ...
    public void extractBidsShouldReturnBidBuildersOrderedByBidPrice() {
        ...
        assertThat(bids).hasSize(4)
                .extracting(
                        org.prebid.server.proto.response.legacy.Bid::getCode,
                        org.prebid.server.proto.response.legacy.Bid::getPrice)
                .containsOnly(
