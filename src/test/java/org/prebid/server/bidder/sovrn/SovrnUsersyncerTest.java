...
public class SovrnUsersyncerTest {
    ...
    public void creationShouldFailOnNullArguments() {
        assertThatNullPointerException().isThrownBy(() -> new SovrnUsersyncer(null, "", false, ""));
        assertThatNullPointerException().isThrownBy(() -> new SovrnUsersyncer("", null, false, ""));
        assertThatNullPointerException().isThrownBy(() -> new SovrnUsersyncer("", "", null, ""));
        assertThatNullPointerException().isThrownBy(() -> new SovrnUsersyncer("", "", false, null));
    }

    @Test
    public void creationShouldInitExpectedUsercyncInfo() {
        assertThat(new SovrnUsersyncer("//usersync.org/", "redirect", false, "http://external.org/").usersyncInfo())
