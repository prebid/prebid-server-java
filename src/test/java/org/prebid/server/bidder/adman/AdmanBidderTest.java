...
public class AdmanBidderTest extends VertxTest {
    ...
    public void makeHttpRequestsShouldReturnErrorIfImpExtCouldNotBeParsed() {
        ...
        assertThat(result.getErrors().get(0).getMessage()).startsWith("Imp.ext could not be parsed");
    }
    ...
    @Test
    public void makeBidsShouldReturnEmptyListIfBidRequestIsNull() throws JsonProcessingException {
        // given
        final BidRequest bidRequest = givenBidRequest(
                impBuilder -> impBuilder.id("123"));
        final HttpCall<BidRequest> httpCall = givenHttpCall(
    ...
    @Test
    public void makeBidsShouldThrowExceptionIsNoImpressionWithIdFound() throws JsonProcessingException {
        // given
        final BidRequest bidRequest = givenBidRequest(
                impBuilder -> impBuilder.id("123"));
        final HttpCall<BidRequest> httpCall = givenHttpCall(
                bidRequest,
                mapper.writeValueAsString(givenBidResponse(bidBuilder -> bidBuilder.impid("125"))));
