...
public class AdvangelistsBidderTest extends VertxTest {
    ...
    public void makeBidsShouldReturnVideoBidWhenVideoPresent() throws JsonProcessingException {
        ...
        assertThat(result.getErrors()).isEmpty();
        assertThat(result.getValue())
                .containsOnly(BidderBid.of(Bid.builder().impid("123").build(), video, null, "USD"));
    }
    ...
    private static BidRequest givenBidRequest(
        ...
        return bidRequestCustomizer.apply(BidRequest.builder()
                .imp(singletonList(givenImp(impCustomizer, extImpAdvangelists))))
                .build();
    }

    private static BidRequest givenBidRequest(Function<Imp.ImpBuilder, Imp.ImpBuilder> impCustomizer) {
        return givenBidRequest(identity(), impCustomizer, ExtImpAdvangelists.of("pubid", "placment"));
    }

    private static BidRequest givenBidRequest(Function<Imp.ImpBuilder, Imp.ImpBuilder> impCustomizer,
                                              ExtImpAdvangelists extImpAdvangelists) {
        return givenBidRequest(identity(), impCustomizer, extImpAdvangelists);
    }
