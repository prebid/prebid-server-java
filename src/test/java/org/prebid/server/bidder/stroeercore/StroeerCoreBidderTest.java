...
public class StroeerCoreBidderTest extends VertxTest {
    ...
    public void makeBidsShouldReturnExpectedBidderBids() throws JsonProcessingException {
        ...
        final BidderHttpCall<BidRequest> httpCall = createHttpCall(response);
    ...
    public void makeBidsShouldReturnErrorIfResponseBodyCouldNotBeParsed() {
        // given
        final BidderHttpCall<BidRequest> httpCall = createHttpCall("[]");
    ...
    public void makeBidsShouldReturnEmptyListIfZeroBids() throws JsonProcessingException {
        // given
        final BidderHttpCall<BidRequest> httpCall = createHttpCall(StroeerCoreBidResponse.of(emptyList()));
    ...
    private BidderHttpCall<BidRequest> createHttpCall(StroeerCoreBidResponse response) throws JsonProcessingException {
        return createHttpCall(mapper.writeValueAsString(response));
    }

    private BidderHttpCall<BidRequest> createHttpCall(String body) {
        return BidderHttpCall.succeededHttp(HttpRequest.<BidRequest>builder().build(),
