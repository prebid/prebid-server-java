...
public class LifestreetUsersyncerTest {
    ...
    public void creationShouldFailOnNullArguments() {
        ...
        assertThatNullPointerException().isThrownBy(() -> new LifestreetUsersyncer("", "", false, null));

    }

    @Test
    public void creationShouldInitExpectedUsercyncInfo() {
        assertThat(new LifestreetUsersyncer("//usersync.org/", "redirect", false, "http://external.org/").usersyncInfo())
