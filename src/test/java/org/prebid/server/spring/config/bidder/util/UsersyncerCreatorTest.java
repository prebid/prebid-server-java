...
//        final UsersyncConfigurationProperties.UsersyncMethodConfigurationProperties methodConfig
//                = new UsersyncConfigurationProperties.UsersyncMethodConfigurationProperties();
//        methodConfig.setUrl("//usersync-url");
//        methodConfig.
//        config.setCookieFamilyName("rubicon");
//        config.setMethods(singletonList(methodConfig));
