...
public class SimulationAwareHttpBidderRequesterTest extends VertxTest {
    ...
    public void setUp() {
        bidderRequester = new SimulationAwareHttpBidderRequester(
                httpClient, bidderInfoRequestValidator, bidderRequestCompletionTrackerFactory, bidderErrorNotifier,
                requestEnricher, lineItemService, jacksonMapper);
    }
    ...
    public void requestBidsShouldThrowPrebidExceptionWhenExtDealsInvalidFormat() {
        ...
        // when and then
        assertThatThrownBy(() -> bidderRequester.requestBids(null, null, bidderRequest, null, requestHeaders, false))
