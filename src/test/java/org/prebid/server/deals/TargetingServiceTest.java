...
public class TargetingServiceTest extends VertxTest {
    ...
    public void matchesTargetingShouldReturnTrue() {
        ...
        // when and then
        assertThat(targetingService.matchesTargeting(auctionContext, imp, targetingDefinition, null)).isTrue();
    ...
    public void matchesTargetingShouldReturnFalseForNotTrueOr() throws IOException {
        ...
        // when and then
        assertThat(targetingService.matchesTargeting(auctionContext, imp, targetingDefinition, null)).isFalse();
    }
