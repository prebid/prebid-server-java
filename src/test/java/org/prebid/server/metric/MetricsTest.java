...
public class MetricsTest {
    ...
    public void shouldReturnAccountAdapterMetricsConfiguredWithAccountAndAdapterType() {
        ...
        // then
        assertThat(metricRegistry.counter("account.accountId.adapter.rubicon.bids_received").getCount()).isEqualTo(1);
    }
    ...
    public void updateAdapterResponseTimeShouldUpdateMetrics() {
        ...
        assertThat(metricRegistry.timer("account.accountId.adapter.rubicon.request_time").getCount()).isEqualTo(1);
    ...
    public void updateAdapterRequestNobidMetricsShouldIncrementMetrics() {
        ...
        assertThat(metricRegistry.counter("account.accountId.adapter.rubicon.requests.nobid").getCount()).isEqualTo(1);
