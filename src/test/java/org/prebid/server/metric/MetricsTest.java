...
public class MetricsTest {
    ...
    public void updateAnalyticWithEventTypeShouldUpdateMetricsAsExpected() {
        ...
        metrics.updateAnalyticEventMetric(ANALYTIC_CODE, MetricName.event_setuid, MetricName.invalid_request);
        ...
        assertThat(metricRegistry.counter("analytics.analyticCode.setuid.invalid_request").getCount()).isOne();
    }
