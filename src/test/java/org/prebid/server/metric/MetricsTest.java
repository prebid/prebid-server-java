...
public class MetricsTest {
    ...
    public void updateAdapterBidMetricsShouldUpdateMetrics() {
        ...
        metrics.updateEmptyBidValidationMetrics(CONVERSANT, ACCOUNT_ID);
        ...
        assertThat(metricRegistry.counter("adapter.conversant.response.validation.empty-bid").getCount()).isEqualTo(1);
    ...
    public void updateBidIdValidationMetricsShouldIncrementMetrics() {
        ...
        metrics.updateBidIdValidationMetrics(CONVERSANT, ACCOUNT_ID);

        // then
        assertThat(metricRegistry.counter("adapter.rubicon.response.validation.bidid").getCount()).isEqualTo(1);
        assertThat(metricRegistry.counter("adapter.conversant.response.validation.bidid").getCount()).isEqualTo(1);
    ...
    public void updateImpIdValidationMetricsShouldIncrementMetrics() {
        ...
        metrics.updateImpIdValidationMetrics(CONVERSANT, ACCOUNT_ID);

        // then
        assertThat(metricRegistry.counter("adapter.rubicon.response.validation.impid").getCount()).isEqualTo(1);
        assertThat(metricRegistry.counter("adapter.conversant.response.validation.impid").getCount()).isEqualTo(1);
    ...
    public void updateCridValidationMetricsShouldIncrementMetrics() {
        ...
        metrics.updateCridValidationMetrics(CONVERSANT, ACCOUNT_ID);

        // then
        assertThat(metricRegistry.counter("adapter.rubicon.response.validation.crid").getCount()).isEqualTo(1);
        assertThat(metricRegistry.counter("adapter.conversant.response.validation.crid").getCount()).isEqualTo(1);
    ...
    public void updatePriceEmptyValidationMetricsShouldIncrementMetrics() {
        ...
        metrics.updatePriceEmptyValidationMetrics(CONVERSANT, ACCOUNT_ID);
        ...
        assertThat(metricRegistry
                .counter("adapter.conversant.response.validation.price.empty").getCount()).isEqualTo(1);
    ...
    public void updatePriceNegativeValidationMetricsShouldIncrementMetrics() {
        ...
        metrics.updatePriceNegativeValidationMetrics(CONVERSANT, ACCOUNT_ID);

        // then
        assertThat(metricRegistry.counter("adapter.rubicon.response.validation.price.negative").getCount())
                .isEqualTo(1);
        assertThat(metricRegistry.counter("adapter.conversant.response.validation.price.negative").getCount())
                .isEqualTo(1);
    ...
    public void updatePriceZeroNonDealValidationMetricsShouldIncrementMetrics() {
        ...
        metrics.updatePriceZeroNonDealValidationMetrics(CONVERSANT, ACCOUNT_ID);

        // then
        assertThat(metricRegistry.counter("adapter.rubicon.response.validation.price.zero-non-deal").getCount())
                .isEqualTo(1);
        assertThat(metricRegistry.counter("adapter.conversant.response.validation.price.zero-non-deal").getCount())
                .isEqualTo(1);
