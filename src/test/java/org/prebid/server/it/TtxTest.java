...
public class TtxTest extends IntegrationTest {
    ...
    public void openrtb2AuctionShouldRespondWithBidsFrom33Across() throws IOException, JSONException {
        ...
        WIRE_MOCK_RULE.stubFor(post(urlPathEqualTo("/ttx-exchange"))
                .withRequestBody(equalToJson(jsonFrom("openrtb2/ttx/test-ttx-bid-request.json")))
                .willReturn(aResponse().withBody(jsonFrom("openrtb2/ttx/test-ttx-bid-response.json"))));
