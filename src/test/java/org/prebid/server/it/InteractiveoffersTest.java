...
public class InteractiveoffersTest extends IntegrationTest {
    ...
    public void openrtb2AuctionShouldRespondWithBidsFromInteractiveoffers() throws IOException, JSONException {
        ...
        WIRE_MOCK_RULE.stubFor(post(urlPathEqualTo("/interactiveoffers-exchange"))
                .withRequestBody(equalToJson(jsonFrom("openrtb2/interactiveoffers/test-interactiveoffers-bid-request.json")))
                .willReturn(aResponse().withBody(jsonFrom("openrtb2/interactiveoffers/test-interactiveoffers-bid-response.json"))));

        // pre-bid cache
        WIRE_MOCK_RULE.stubFor(post(urlPathEqualTo("/cache"))
                .withRequestBody(equalToJson(jsonFrom("openrtb2/interactiveoffers/test-cache-interactiveoffers-request.json")))
                .willReturn(aResponse().withBody(jsonFrom("openrtb2/interactiveoffers/test-cache-matcher-interactiveoffers.json"))));
