...
public class AdmanTest extends IntegrationTest {
    ...
    public void openrtb2AuctionShouldRespondWithBidsFromAdman() throws IOException, JSONException {
        ...
        WIRE_MOCK_RULE.stubFor(post(urlPathEqualTo("/cache"))
                .withRequestBody(equalToJson(jsonFrom("openrtb2/adman/test-cache-adman-request.json")))
                .willReturn(aResponse().withBody(jsonFrom("openrtb2/adman/test-cache-adman-response.json"))));
