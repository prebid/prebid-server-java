...
public class InmobiTest extends IntegrationTest {
    ...
    public void openrtb2AuctionShouldRespondWithBidsFromKubient() throws IOException, JSONException {
        ...
        WIRE_MOCK_RULE.stubFor(post(urlPathEqualTo("/inmobi-exchange"))
                .withRequestBody(equalToJson(jsonFrom("openrtb2/inmobi/test-inmobi-bid-request-1.json")))
                .willReturn(aResponse().withBody(jsonFrom("openrtb2/inmobi/test-inmobi-bid-response-1.json"))));
        ...
        final Response response = given(SPEC)
                ...
                // this uids cookie value stands for {"uids":{"orbidder":"IM-UID"}}
