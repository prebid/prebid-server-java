...
public class MedianetTest extends IntegrationTest {
    ...
    public void openrtb2AuctionShouldRespondWithBidsFromTheMedianet() throws IOException, JSONException {
        ...
        WIRE_MOCK_RULE.stubFor(post(urlPathEqualTo("/cache"))
                .withRequestBody(equalToJson(jsonFrom("openrtb2/medianet/test-cache-medianet-request.json")))
                .willReturn(aResponse().withBody(jsonFrom("openrtb2/medianet/test-cache-medianet-response.json"))));
