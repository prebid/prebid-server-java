...
public class RevcontentTest extends IntegrationTest {
    ...
    public void openrtb2AuctionShouldRespondWithBidsFromTheRevcontentTest() throws IOException, JSONException {
        ...
        WIRE_MOCK_RULE.stubFor(post(urlPathEqualTo("/cache"))
                .withRequestBody(equalToJson(jsonFrom("openrtb2/revcontent/test-cache-revcontent-request.json")))
                .willReturn(aResponse().withBody(jsonFrom("openrtb2/revcontent/test-cache-revcontent-response.json"))));
