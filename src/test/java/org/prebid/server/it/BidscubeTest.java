...
public class BidscubeTest extends IntegrationTest {
    ...
    public void openrtb2AuctionShouldRespondWithBidsFromBidscube() throws IOException, JSONException {
        ...
        final Response response = given(SPEC)
                ...
                .body(jsonFrom("openrtb2/bidscube/test-auction-bidscube-request.json"))
                .post("/openrtb2/auction");

        // then
        final String expectedAuctionResponse = openrtbAuctionResponseFrom(
                "openrtb2/bidscube/test-auction-bidscube-response.json",
                response, singletonList("bidscube"));
