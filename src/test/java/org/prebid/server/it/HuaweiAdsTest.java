...
public class HuaweiAdsTest extends IntegrationTest {
    ...
    public void testOpenrtb2AuctionCoreFunctionality() throws IOException, JSONException {
        ...
        // when
        final Response response = responseFor("openrtb2/huaweiads/test-huaweiads-auction-request.json",
                Endpoint.openrtb2_auction);

        // then
        assertJsonEquals("openrtb2/huaweiads/test-huaweiads-auction-response.json", response,
                singletonList("huaweiads"));
    }
}
