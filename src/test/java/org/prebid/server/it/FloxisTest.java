...
public class FloxisTest extends IntegrationTest {
    ...
    public void openrtb2AuctionShouldRespondWithBidsFromFloxis() throws IOException, JSONException {
        ...
        // when
        final Response response = responseFor("openrtb2/floxis/test-auction-floxis-request.json",
                Endpoint.openrtb2_auction);

        // then
        assertJsonEquals("openrtb2/floxis/test-auction-floxis-response.json", response, singletonList("floxis"));
    }
}
