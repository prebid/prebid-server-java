...
public class CircuitBreakerSecuredHttpClientTest {
    ...
    public void setUp() {
        ...
        httpClient = new CircuitBreakerSecuredHttpClient(vertx, wrappedHttpClient, metrics, 1, 24, 100L, 200L, clock);
    }
    ...
    public void requestShouldFailWithOriginalExceptionIfOpeningIntervalExceeds(TestContext context) {
        // given
        httpClient = new CircuitBreakerSecuredHttpClient(vertx, wrappedHttpClient, metrics, 2, 24, 100L, 200L, clock);
