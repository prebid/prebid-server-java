...
public class IndexExchangeAdapterTest extends VertxTest {
    ...
    public void requestBidsShouldSendBidRequestWithExpectedFields() throws IOException {
        ...
        bidder = givenBidderCustomizable(
                ...
                paramsBuilder -> paramsBuilder.siteId(486));
    ...
    private static Bidder givenBidderCustomizable(
            ...
            Function<IndexExchangeParams.IndexExchangeParamsBuilder, IndexExchangeParams.IndexExchangeParamsBuilder>
    ...
    private static AdUnitBid givenAdUnitBidCustomizable(
        ...
        // params
        final IndexExchangeParams.IndexExchangeParamsBuilder paramsBuilder = IndexExchangeParams.builder()
                .siteId(42);
        final IndexExchangeParams.IndexExchangeParamsBuilder paramsBuilderCustomized = paramsBuilderCustomizer
                .apply(paramsBuilder);
        final IndexExchangeParams params = paramsBuilderCustomized.build();
