...
public class AlvaAdsConfiguration {

    private static final String BIDDER_NAME = "alvads";

    @Bean("alvaAdsConfigurationProperties")
    ...
    @Bean
    BidderDeps alvaAdsBidderDeps(BidderConfigurationProperties alvaAdsConfigurationProperties,
                                 @NotBlank @Value("${external-url}") String externalUrl,
                                 JacksonMapper mapper) {

        return BidderDepsAssembler.forBidder(BIDDER_NAME)
                .withConfig(alvaAdsConfigurationProperties)
