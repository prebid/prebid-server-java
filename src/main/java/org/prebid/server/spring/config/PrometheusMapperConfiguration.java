...
public class PrometheusMapperConfiguration {
    ...
    private final MapperConfig bidderCardinality = new MapperConfig(
    ...
    private final List<MapperConfig> vertxResponseConfig = Stream.of(
            "1xx", "2xx", "3xx", "4xx"
    ...
    private final MapperConfig vertxServer = new MapperConfig(
            "vertx.http.servers.*.*.*.*.*", "vertx.http.servers.${4}",
            Map.of("address", "${0}.${1}.${2}.${3}"));

    private List<MapperConfig> privacyMappingConfigs() {
        ...
        return Arrays.asList(privacyTcfMissing, privacyTcfInvalid, privacyVendorList, privacyTcfStatus);
    }

    private List<MapperConfig> accountModuleMapperConfigs() {
    ...
    private List<MapperConfig> moduleMapperConfigs() {
    ...
    private List<MapperConfig> accountMapperConfigs() {
        ...
        return Arrays.asList(accountAdapterRequests, accountAdapterBidsReceived, accountRequestTypeConfig,
                accountRequestTime, accountPricesConfig, accountValidationConfig, accountCacheConfig,
                accountRequestsConfig);
    }

    private List<MapperConfig> adapterMapperConfigs() {
        ...
        return Arrays.asList(adapterRequestsType, adapterRequestsResult, adapterPrices,
