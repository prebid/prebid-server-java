...
public class GenericBidderConfiguration {
    ...
    @Bean("genericConfigurationProperties")
    ...
    @Bean
    BidderDeps genericBidderDeps(BidderConfigurationProperties genericConfigurationProperties,
                                 @NotBlank @Value("${external-url}") String externalUrl,
                                 JacksonMapper mapper) {

        return BidderDepsAssembler.forBidder(BIDDER_NAME)
                .withConfig(genericConfigurationProperties)
