...
public class GetInterfaceHandler implements ApplicationResource {

    private static final Logger logger = LoggerFactory.getLogger(GetInterfaceHandler.class);
    private static final ConditionalLogger conditionalLogger = new ConditionalLogger(logger);

    private final double logSamplingRate;
    private final GetInterfaceRequestFactory getInterfaceRequestFactory;
    ...
    public GetInterfaceHandler(double logSamplingRate,
        ...
        this.getInterfaceRequestFactory = Objects.requireNonNull(getInterfaceRequestFactory);
    ...
    public List<HttpEndpoint> endpoints() {
        return Collections.singletonList(HttpEndpoint.of(HttpMethod.GET, Endpoint.openrtb2_get_interface.value()));
    }
    ...
    public void handle(RoutingContext routingContext) {
        ...
        getInterfaceRequestFactory.fromRequest(routingContext, startTime)
    ...
    private Future<AuctionContext> holdAuction(AuctionEvent.AuctionEventBuilder auctionEventBuilder,
        ...
        return getInterfaceRequestFactory.enrichAuctionContext(auctionContext)
    ...
    private void handleResult(AsyncResult<RawResponseContext> responseResult,
        ...
        httpInteractionLogger.maybeLogOpenrtb2GetInterface(auctionContext, routingContext, status.code(), body);
    }
    ...
    private boolean respondWith(RoutingContext routingContext,
        ...
        return HttpUtil.executeSafely(
                routingContext,
                Endpoint.openrtb2_get_interface,
                response -> response
