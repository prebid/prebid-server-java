...
public class ParametrizedDecompressionHandler implements Handler<RoutingContext> {
    ...
    private static Buffer decompressGzip(Buffer compressed) throws IOException {
        try (ByteArrayInputStream input = new ByteArrayInputStream(compressed.getByteBuf().array());
