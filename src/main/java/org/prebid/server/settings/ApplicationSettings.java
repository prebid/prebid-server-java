...
public interface ApplicationSettings {
     ...
     */
    Future<StoredRequestResult> getStoredData(Set<String> requestIds, Set<String> impIds, Timeout timeout);

    /**
     * Fetches AMP stored requests and imps
     */
    Future<StoredRequestResult> getAmpStoredData(Set<String> requestIds, Set<String> impIds, Timeout timeout);
}
