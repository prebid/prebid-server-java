...
public class BasicCategoryMappingService implements CategoryMappingService {
    ...
    private Map<String, ExtDealTier> extractBidderToDealTiers(Imp imp, List<String> errors) {
        ...
        final ExtImp<ExtImpPrebid, ?> extImp = parseImpExt(impExt);
    ...
    private ExtImp<ExtImpPrebid, ?> parseImpExt(ObjectNode impExt) {
        try {
            return jacksonMapper.mapper().convertValue(impExt, EXT_IMP_TYPE_REFERENCE);
