...
public class CookieSyncPrivacyContextFactory {
    ...
    public CookieSyncPrivacyContextFactory(PrivacyExtractor privacyExtractor,
    ...
    public Future<PrivacyContext> contextFrom(CookieSyncRequest cookieSyncRequest,
        ...
        return tcfDefinerService.resolveTcfContext(
                        ...
                        MetricName.cookiesync,
                        RequestLogInfo.of(MetricName.cookiesync, null, account.getId()),
                        timeout)
