...
public class RhythmoneUsersyncer implements Usersyncer {
    ...
    public RhythmoneUsersyncer(String usersyncUrl, String type, Boolean supportCORS, String externalUrl) {
    ...
    private static UsersyncInfo createUsersyncInfo(String usersyncUrl, String type, Boolean supportCORS,
        ...
        final String redirectUri = HttpUtil.encodeUrl(externalUrl)
                + "%2Fsetuid%3Fbidder%3Drhythmone%26gdpr%3D{{gdpr}}%26gdpr_consent%3D{{gdpr_consent}}"
    ...
    /**
     * Returns RhythmOne cookie family
     */
    @Override
    ...
    /**
     * Returns RhythmOne {@link UsersyncInfo}
     */
    @Override
