              ...
              "groups": [
                {
                  ...
                  "hook_sequence": [
                    {
                      "module_code": "pb-wurfl-devicedetection",
                      "hook_impl_code": "pb-wurfl-devicedetection-entrypoint-hook"
                    }
                  ]
                }
              ]
              ...
              "groups": [
                {
                  ...
                  "hook_sequence": [
                    {
                      "module_code": "pb-wurfl-devicedetection",
                      "hook_impl_code": "pb-wurfl-devicedetection-raw-auction-request"
                    }
                  ]
                }
              ]
...
```bash
curl http://localhost:8080/openrtb2/auction --data @extra/modules/pb-wurfl-devicedetection/sample/request_data.json
```
