...
public class EidAvailableFunctionTest {

    private static final ObjectMapper mapper = new ObjectMapper();

    private final EidAvailableFunction target = new EidAvailableFunction();
    ...
    @Test
    public void extractShouldReturnTrueWhenEidsArePresent() {
        // given
        final BidRequest bidRequest = BidRequest.builder()
                .user(User.builder().eids(Collections.singletonList(Eid.builder().build())).build())
                .build();
    ...
    @Test
    public void extractShouldReturnFalseWhenEidsAreAbsent() {
        // given
        final BidRequest bidRequest = BidRequest.builder()
    ...
    @Test
    public void extractShouldReturnFalseWhenEidsListContainsOnlyNulls() {
        // given
        final BidRequest bidRequest = BidRequest.builder()
